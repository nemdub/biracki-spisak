...
const ASSET_V = "20260614c"; // подигни верзију кад се подаци/код промене (руши кеш)
...
const KAT_LABEL = {
  ...
  "stambeno-moguce": "потенцијално стамбено",
  "nepoznato": "непознато",
  "pomocno": "помоћно",
...
function render() {
  ...
  document.getElementById("lead").innerHTML =
    ...
    `Спојеви на адресама које по <strong>катастру</strong> имају стамбену зграду (мешовите стамбено-пословне зграде — нпр. амбуланта у приземљу стамбеног блока) се изостављају јер ту бирачи легитимно станују. ` +
...
function renderCards(s) {
  ...
  const cards = [
    ...
    { cls: "amber", num: nf.format(sta.objekata), lbl: `потенцијално стамбених (домови, манастири…) — ${nf.format(sta.biraca)} бирача` },
...
function renderCaveats(s) {
  const items = [
    ...
    `<strong>Одбачени лажни позитиви (стамбена зграда по катастру).</strong> Намена адресе се проверава у катастру (преко броја парцеле, исти извор као доња анализа): ако парцела има стамбену зграду, бирачи ту легитимно станују, па се спој изоставља — нпр. ветеринарска амбуланта „Сали вет” у приземљу стамбеног блока на Бул. Арсенија Чарнојевића 145 (катастар: „СТАМБЕНА ЗГРАДА ЗА КОЛЕКТИВНО СТАНОВАЊЕ”). Задржавају се само адресе које по катастру немају стамбену зграду (или нису у покривеној катастарској општини).${s.iskljuceno_stambeno != null ? ` Изостављено ${nf.format(s.iskljuceno_stambeno)} спајања.` : ""}`,
    `<strong>Категорија „потенцијално стамбени”.</strong> Домови за старе, манастири, ученички/студентски домови и сл. су издвојени јер у њима људи легитимно бораве и гласају — нису знак неправилности.`,
